...
import sys
sys.path.append('data/libraries')
import data_io, params, SIF_embedding

# %% Load df

path = 'data/ed-dataset-falcon_spacy2-embeddings-md4.csv'
...
path = 'data/ed-dataset-falcon_spacy2-entities-uniques-embeddings-md4.csv'
...
df.to_csv('data/ed-dataset-falcon_spacy2-embeddings-sentence-md4.csv',sep=';')
...
df_b.to_csv('data/ed-dataset-falcon_spacy2-embeddings-similarity_matrix_2.csv',sep=';')
